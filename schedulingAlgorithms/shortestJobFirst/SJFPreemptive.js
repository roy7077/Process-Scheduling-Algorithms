...
class SJFPreemptive {
    constructor(readyQueue, TQ) {
        ...
        // Run the scheduling process upon instantiation of the class
        this.scheduleProcesses();
    }

    /**
     * Schedules the processes using the Shortest Job First (SJF) Preemptive algorithm.
     * This method manages process execution based on the shortest remaining burst time.
     */
    scheduleProcesses() {
        ...
        while (i < this.readyQueue.length || !pq.isEmpty()) {
            ...
            // If the time quantum is sufficient to complete the current job
